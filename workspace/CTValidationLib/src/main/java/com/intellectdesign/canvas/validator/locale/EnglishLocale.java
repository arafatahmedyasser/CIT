...
/**
 *This class is for EnglishLocale holds all of the characters for en_US locale
 *
 * @version 1.0
 */
public class EnglishLocale extends ValidCharacterSet
{
	/**
	...
	// character array containing the alpha characters for en_US locale
	...
	// character array containing the numeric characters for en_US locale
	...
	// character array containing the entire characters for en_US locale
	...
	/**
	 * Locale specific implementation which returns an array of valid en_US character set
	 * 
	...
	/**
	 * Locale specific implementation which returns an array of valid en_US alpha character set
	 * 
	...
	/**
	 * Locale specific implementation which returns an array of valid en_US numeric character set
	 * 
