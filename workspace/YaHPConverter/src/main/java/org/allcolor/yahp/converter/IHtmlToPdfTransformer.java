...
public interface IHtmlToPdfTransformer
{
	...
	public static class CHeaderFooter
	{
		 ...
		 * 
		 * @param content html content of the element
		 ...
		 * @param content html content of the element
		 * @param type header or footer
		 * @param sfor even, odd or all
		 * 
		 * @throws IllegalArgumentException if type or header have invalid value
		 */
	...
	public static final class PageSize
	{
		...
		/**
		 * index 0 page left margin in centimeter index 1 page right margin in centimeter index 2 page bottom margin in
		 * centimeter index 3 page top margin in centimeter
		 */
		...
		/**
		 * index 0 page left margin in pixel index 1 page right margin in pixel index 2 page bottom margin in pixel
		 * index 3 page top margin in pixel
		 */
		 ...
		 * 
		 * @param width page width in centimeter
		 * @param height page height in centimeter
		 */
		 ...
		 * @param width page width in centimeter
		 * @param height page height in centimeter
		 * @param margin page margin in centimeter
		 */
		 ...
		 * @param width page width in centimeter
		 * @param height page height in centimeter
		 * @param lmargin page left margin in centimeter
		 * @param rmargin page right margin in centimeter
		 * @param bmargin page bottom margin in centimeter
		 * @param tmargin page top margin in centimeter
		 */
		 ...
		 * Creates a new PageSize object.
		 * 
		 * @param width page width in pixel
		 * @param height page height in pixel
		 */
		 ...
		 * @param width page width in pixel
		 * @param height page height in pixel
		 * @param margin page margin in pixel
		 */
		 ...
		 * @param width page width in pixel
		 * @param height page height in pixel
		 * @param lmargin page left margin in pixel
		 * @param rmargin page right margin in pixel
		 * @param bmargin page bottom margin in pixel
		 * @param tmargin page top margin in pixel
		 * 
		 * @throws AssertionError if margin or width or height invalid
		 */
	...
	/**
	 * The operation permitted when the document is opened with the user password. USE_PDF_ENCRYPTION must be set to
	 * true for this property to have an effect.
	 */
	...
	/**
	 * Set this property with the desired password of pdf encryption. USE_PDF_ENCRYPTION must be set to true for this
	...
	/**
	 * default to true. Use an hand made certificate. To generate one : keytool -genkey -keyalg RSA -alias myname
	 * -keypass password -keystore keystore.ks -dname "cn=Your Name, c=CC" CC == Country code
	 */
	public static final String USE_PDF_SELF_SIGNING = "yahp.USE_PDF_SELF_SIGNING";

	/**
	 * set to true to sign a document with a certificate PDF_SIGNING_PRIVATE_KEY_PASSWORD,
	 * PDF_SIGNING_KEYSTORE_PASSWORD, PDF_SIGNING_PRIVATE_KEY_FILE must be set. PDF_SIGNING_REASON,
	 ...
	 * @param properties pdf renderer properties list
	 * @param out out stream to the pdf file precondition: in != null precondition: urlForBase != null precondition:
	 *            size != null precondition: != null precondition: properties != null precondition: out != null
	 * 
	 * @throws CConvertException if a conversion exception occurs
	 */
	public void transform(final InputStream in, final String urlForBase, final PageSize size, final List hf,
