...
public final class CSystem
{
	...
	public static String getOS()
	{
		...
		String OS = java.lang.System.getProperty("os.name", "unknown").toLowerCase();
		...
		{
			OS = "solaris";
		} else if (((OS.indexOf("mac") != -1) && (OS.indexOf("os") != -1) && (OS.indexOf("x") != -1))
				|| (OS.indexOf("rhapsody") != -1) || (OS.indexOf("darwin") != -1))
		{
			OS = "macosx";
	...
	public static String getArchitecture()
	{
		...
		String arch = java.lang.System.getProperty("os.arch", "unknown").toLowerCase();
		if (((arch.indexOf("ia") != -1) && (arch.indexOf("64") != -1)) || (arch.indexOf("ia64") != -1))
		{
			arch = "ia_64";
		} else if ((arch.indexOf("amd64") != -1) || ((arch.indexOf("86") != -1) && (arch.indexOf("64") != -1)))
		{
			arch = "x86_64";
		...
		{
			arch = "alpha";
		} else if ((arch.indexOf("pa") != -1) && (arch.indexOf("risc") != -1) && (arch.indexOf("2") != -1))
		{
			arch = "parisc2";
