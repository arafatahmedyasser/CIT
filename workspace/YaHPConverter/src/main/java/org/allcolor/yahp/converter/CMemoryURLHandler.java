...
public class CMemoryURLHandler extends URLStreamHandler
{
	...
	protected static URL createMemoryURL(String entryName, byte[] entry) throws MalformedURLException
	{
		if (!entryName.startsWith("/"))
		{
			entryName = "/" + entryName;
		}
		URL url = new URL("yahpmemory", "localhost", -1, entryName, handler);
	...
	protected URLConnection openConnection(URL u) throws IOException
	{
		...
		if (array == null)
		{
			throw new IOException("resource " + u.toExternalForm() + " not found !");
		}
