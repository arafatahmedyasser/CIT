...
/**
 * Class used to handle Decryption Exception
 * 
 * @version 1.0
 */
public class DecryptionException extends BaseException
{
	 ...
	 */
	private static final long serialVersionUID = 6412005938979321165L;
	 ...
	 * @param errorCode
	 */
	public DecryptionException(String errorCode)
	{
		super(errorCode);
	 ...
	 * @param wrappedEx
	 */
	public DecryptionException(Throwable wrappedEx)
	{
		super(wrappedEx);
	 ...
	 * @param wrappedEx
	 */
	public DecryptionException(String errorCode, Throwable wrappedEx)
	{
	 ...
	 * @param wrappedEx
	 */
	public DecryptionException(String errorCode, String errorMessage, Throwable wrappedEx)
	{
