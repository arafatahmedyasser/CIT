...
/**
 * This class is for canvas default tree view instruction extends tree list instruction
 * 
 * @version 1.0
 */
public class CanvasDefaultTreeViewInstruction extends TreeListInstruction
{

	/**
	 * this is ref to TreeViewInstruction ViewSpecificationFilters
	 * 
	 * @param hmInputParams
	...
	/**
	 * this is ref to ArrayList to GetDataAstreeStructure
	 * 
	 * @param treeList
	 * @param mapInputParams
	 * @return
	 * @see com.intellectdesign.canvas.viewdefinition.instruction.TreeListInstruction#getDataAsTreeStructure(java.util.ArrayList,
	 *      java.util.HashMap)
	 */
	@Override
	...
	private static Logger logger = Logger.getLogger(CanvasDefaultTreeViewInstruction.class);
