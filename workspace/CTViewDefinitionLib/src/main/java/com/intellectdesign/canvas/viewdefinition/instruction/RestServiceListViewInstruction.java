...
/**
 * This class uses the rest services to fetch data for all the list views.
 * 
 ...
 * @version 1.0
 */
public abstract class RestServiceListViewInstruction extends ListViewsInstruction
{
