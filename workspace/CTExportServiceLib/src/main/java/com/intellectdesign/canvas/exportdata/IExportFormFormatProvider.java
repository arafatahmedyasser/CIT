...
/**
 * This Interface provides API to manipulate the data for the form based export options.
 * 
 * @version 1.0
 */
public interface IExportFormFormatProvider
{

	/**
	 * This method is uesd to get the ExportFormFormat
	 * 
	 * @param exportDataVO
	 * @param userValue
	 * @return String
