 ...
 * 
 * @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/SYNC_REPORT_QUEUE") })
 */

/**
 * The listener class for Asynchronous communication(SYNC_QUEUE)
 * 
 * @version 1.0
 */
public class InfoReportsSyncMessageListener implements MessageDrivenBean, MessageListener
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -7321199695161972889L;
	...
	{
		final String cmName = "InfoReportsSyncMessageListener.onMessage";
	...
	private Logger LOGGER = Logger.getLogger(InfoReportsSyncMessageListener.class);
}
