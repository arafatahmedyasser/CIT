...
/*
 *This class is used for creating the Table for displaying 
 *the form component in tabular fashion.
**/
cbx.lib.layout.TableFormLayout = Class(cbx.core.Component,{
	...
	initialize: function (){
		...
		// Creating table for adding all the form components in to it 
		var tableFormConfig = {
			"eleType": "table"
		};
