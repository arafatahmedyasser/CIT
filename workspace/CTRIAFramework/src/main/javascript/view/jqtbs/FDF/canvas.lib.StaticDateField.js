 ...
 * @description This component is currently responsible for rendering static date field element.
 */
canvas.lib.StaticDateField = Class(canvas.lib.FormElements, {
...
CFCR.registerFormCmp({
	...
	'COMP_NAME' : 'cbx-staticdatefield'
}, canvas.lib.StaticDateField);
