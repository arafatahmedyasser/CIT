 ...
 * @description This component is currently responsible for rendering static rate field element.
 */
canvas.lib.StaticRateField = Class(canvas.lib.FormElements, {
	
	/**
	 * @method setFieldValue
	 * @memberof "canvas.lib.StaticRateField"
...
CFCR.registerFormCmp({
	...
	'COMP_NAME' : 'cbx-displayratefield'
}, canvas.lib.StaticRateField);
