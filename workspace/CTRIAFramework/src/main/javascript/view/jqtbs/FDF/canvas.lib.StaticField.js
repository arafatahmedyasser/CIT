 ...
 * @description This component is currently responsible for rendering static field element.
 */
canvas.lib.StaticField = Class(canvas.lib.FormElements, {
	/**
	 * @method setFieldValue
	 * @memberof "canvas.lib.StaticField"
...
CFCR.registerFormCmp({
	...
	'COMP_NAME' : 'cbx-staticfield'
}, canvas.lib.StaticField);
