 ...
 * @description This component is currently responsible for rendering static text area element.
 */
canvas.lib.StaticTextarea = Class(canvas.lib.FormElements, {
	/**
	 * @method setFieldValue
	 * @memberof "canvas.lib.StaticTextarea"
...
CFCR.registerFormCmp({
	...
	'COMP_NAME' : 'cbx-statictextarea'
}, canvas.lib.StaticTextarea);
