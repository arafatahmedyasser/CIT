...
canvas.lib.layout.twocolumn = Class(cbx.core.Component,	{
	/**
	 * @class "canvas.lib.layout.twocolumn"
	 * @description The constructor gets the metadata and initialises the other methods in the class namely 'initializeColumns' and 'generateTwoCol'.
	 */
	proportion : [ 50, 50 ],
	 ...
	 * @memberof "canvas.lib.layout.twocolumn"
	 * @description This method is responsible for generating a DOM structure with 2 columns 
	 * 				using lib layer. 
	 */
	initializeColumns : function() {
		...
		if(this.proportion[0] !=null || this.proportion[1]!=null){
		...
		var rightColConfig = {
			"eleType" : "div",
			'class' : 'content-right col-md-'+prop2
		}
