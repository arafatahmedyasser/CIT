 ...
 * @description This component is currently responsible Jquery Framework to rendered menu layout footer.
 */

canvas.applnlayout.menu.footer = Class({
	/**
	 * @class "canvas.applnlayout.menu.footer"
	...
	/**
	 * @method getFooterDOM
	 * @memberof "canvas.applnlayout.menu.footer"
	 * @description This method gets the list of workspaces and passes it to the template (menufooter.cttpl) and
	...
	getFooterDOM : function() {
		...
		var tmpLayer = new ct.lib.tmplLayer('al-menu-footer.cttpl',this);
...
CLCR.registerCmp({
	...
	},canvas.applnlayout.menu.footer);
