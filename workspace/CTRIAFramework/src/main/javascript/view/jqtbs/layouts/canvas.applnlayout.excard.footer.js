 ...
 * @description This component is currently responsible Jquery Framework to rendered excard layout footer.
 */

canvas.applnlayout.excard.footer = Class({
	/**
	 * @class "canvas.applnlayout.excard.footer"
	...
	/**
	 * @method getFooterDOM
	 * @memberof "canvas.applnlayout.excard.footer"
	 * @description This method gets the list of workspaces and passes it to the template (excardfooter.cttpl) and
	...
	getFooterDOM : function() {
		...
		var tmpLayer = new ct.lib.tmplLayer('al-excard-footer.cttpl',this);
	...
	applyTemplate : function (template, tmpClass)
	{
		...
		$('body').bind('load',function() {
			var reqWindowHeight = $(window).height() + 40;
...
CLCR.registerCmp({
	...
	},canvas.applnlayout.excard.footer);
