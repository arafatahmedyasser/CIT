        ...
        if (n.attributes.details) {
            for (var x = 0; x < n.attributes.details.length; x++) {
                ...
                buf += ["<br/>",
                        ...
                        (n.hasChildNodes()) ? '<img src="' + this.emptyIcon + '" class="x-tree-ec-icon x-tree-elbow-line-multiline-expanded" style="margin-right: -14px;"/>' : '<span style="margin-left: 2px;"></span>',
