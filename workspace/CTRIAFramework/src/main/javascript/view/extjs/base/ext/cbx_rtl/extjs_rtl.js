...
Ext.override(Ext.TabPanel, {
    autoScrollTabs : function(){
		...
		var l = wd.scrollWidth-(this.edge.getOffsetsTo(this.stripWrap)[0] + pos);
		//this.edge.getOffsetsTo(this.stripWrap)[0] ;//+ pos;
        ...
        if(l <= tw && l > 0){
            wrap.setWidth(tw);
            if(this.scrolling){
            	wd.scrollLeft = wd.scrollWidth-cw;
    ...
    updateScrollButtons : function(){
    	...
    	this.scrollRight[pos == (5000-this.getScrollArea()) ? 'addClass' : 'removeClass']('x-tab-scroller-right-disabled');
