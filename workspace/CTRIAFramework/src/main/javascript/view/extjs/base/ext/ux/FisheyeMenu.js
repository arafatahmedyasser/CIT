...
Ext.ux.FisheyeMenu = Ext.extend(Ext.util.Observable, {
    ...
    initMarkup : function() {
        ...
        Ext.each(this.items, function(item, index) {
            ...
            this.containerEl.createChild({
				tag : 'a',
				id : sId + '-' + index,
				cls : 'ux-fisheye-menu-item  item-show ' + this.vAlignCls,
				href : item.url || '#',
				title : sTitle,
    ...
    */
	...
	add: function(item){
		...
		//CBXR12Q312F05 ends	       
            var arr = [{
                ...
                cls: 'excatalogiconDefault wgticon'+item.iconCls,
                title : sTitle
            ...
            this.containerEl.createChild({
				tag : 'a',
				id : item.itemId,
				cls : item.hidden===true?'ux-fisheye-menu-item excatlogiconholder ' + this.vAlignCls:'ux-fisheye-menu-item  item-show excatlogiconholder ' + this.vAlignCls,
				title : sTitle,
	...
	handleClick: function(){
		this.catalog.hide(this.itemId);
		this.handler.apply(this);
	},
	removeAll: function(){
		var items=this.containerEl.select('a.ux-fisheye-menu-item');		
