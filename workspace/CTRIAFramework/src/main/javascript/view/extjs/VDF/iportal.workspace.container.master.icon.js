...
canvas.applnlayout.card.master.icon = Ext.extend(Ext.Panel, {
	//width: 255,
	/**
	 ...
	 */
	tpl : new Ext.XTemplate('<div class="widget_holder"><center>', '<div class="cardwsiconDefault {ICON_CLS}"></div>', 
				'<div class="cardws_text">{LABEL}</div>', '</center>', '</div>'), 
	/**
	...
	initComponent : function (){
		...
		canvas.applnlayout.card.master.icon.superclass.initComponent.call(this);
	},
	/**
	...
	onRender : function (ct, position){
		canvas.applnlayout.card.master.icon.superclass.onRender.call(this, ct, position);
		this.update();
	},
	/**
	...
	afterRender : function (){
		...
		canvas.applnlayout.card.master.icon.superclass.afterRender.apply(this, arguments);
	}
});
Ext.reg('iportal-master-icon', canvas.applnlayout.card.master.icon);