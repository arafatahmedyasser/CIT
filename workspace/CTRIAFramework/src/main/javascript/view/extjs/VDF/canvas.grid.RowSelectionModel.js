...
canvas.grid.RowSelectionModel = Ext.extend(Ext.grid.AbstractSelectionModel, {
    ...
    constructor : function(config){
        ...
        canvas.grid.RowSelectionModel.superclass.constructor.call(this);
    },
     ...
     * @param {rowIndex} index of the row to identified selected or not.
  ...
  //rowselection anand
    ...
    destroy : function(){
        ...
        this.rowNav = null;
        canvas.grid.RowSelectionModel.superclass.destroy.call(this);
    }
});